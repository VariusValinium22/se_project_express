module.exports = {
  ...
  AUTHORIZATION_ERROR: { code: 401, message: "Authorization required", type: "Authorization" },
  FORBIDDEN_ERROR: { code: 403, message: "You are not authorized to delete this item", type: "Permission" },
